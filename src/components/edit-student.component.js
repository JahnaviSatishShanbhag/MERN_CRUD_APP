...
export default class EditStudent extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`http://localhost:3000/students/edit-student/${this.props.match.params.id}`)
            .then((response) => {
    ...
    onSubmit(e) {
        ...
        fetch(`http://localhost:3000/students/update-student/${this.props.match.params.id}`,
            {
                method: 'PUT',
                headers: {
